...
describe('beats — trump vs non-trump', function () {
    it('trump beats any non-trump regardless of rank', function () {
        ...
        expect($so->beats($twoOfTrump, $aceOfHearts, Suit::Hearts))->toBeTrue()
            ->and($so->beats($aceOfHearts, $twoOfTrump, Suit::Hearts))->toBeFalse();
    });
});
